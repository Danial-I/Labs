...
music_folder = "C:/Users/acer/PycharmProjects/PythonProject1/lab7/musics"
...
playb = pygame.image.load(os.path.join("music_element", "play.png"))
pausb = pygame.image.load(os.path.join("music_element", "pause.png"))
nextb = pygame.image.load(os.path.join("music_element", "next.png"))
prevb = pygame.image.load(os.path.join("music_element", "back.png"))
